...
constexpr int glv1 = 3;
constexpr int glv2 = 1;
constexpr int gles = true;
int main()
{
    ...
    morph::Visual<glv1,glv2,gles> v(1600, 1000, "morph::HexGridVisual", {-0.8,-0.8}, {.05,.05,.05}, 2.0f, 0.0f);
    ...
    auto hgv = std::make_unique<morph::HexGridVisual<float,glv1,glv2,gles>>(&hg, offset);
    v.bindmodel (hgv);
