...
int main()
{
    ...
    morph::Grid<100, 100, grid_spacing, grid_zero, d_wrap, g_order> grid;
    ...
    auto gv = std::make_unique<morph::GridVisual<float, 100, 100, grid_spacing, grid_zero, d_wrap, g_order>>(grid, offset);
    v.bindmodel (gv);
