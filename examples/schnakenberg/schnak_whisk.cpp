/*
 * A morphologica example: The Schnakenberg Turing-like RD system running in a whisker-like domain.
 *
 * Author: Seb James
 */
...
int main (int argc, char **argv)
{
    ...
    v1.bgcolour = {0.2f, 0.2f, 0.2f, 1.0f};
    ...
    RD.svgpath = conf.getString ("svgpath", "");
