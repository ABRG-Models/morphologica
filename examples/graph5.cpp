...
int main()
{
    ...
    std::string ds1legend = morph::unicode::toUtf8 (morph::unicode::alpha);
    ds1legend += "(x) = x" + morph::unicode::toUtf8 (morph::unicode::ss3);
    gv->setdata (x, x.pow(3), ds1legend);
    gv->ylabel = morph::unicode::toUtf8 (morph::unicode::alpha);

    // And 100x^2
    std::string ds2legend = morph::unicode::toUtf8 (morph::unicode::beta);
    ds2legend += "(x) = 100x" + morph::unicode::toUtf8 (morph::unicode::ss2);
    gv->setdata_rightaxis (x, x.pow(2)*100, ds2legend);
    gv->ylabel2 = morph::unicode::toUtf8 (morph::unicode::beta);
