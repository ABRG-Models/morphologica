...
int main()
{
    ...
    morph::Visual<morph::gl::version_3_1_es> v(800,600,"Convolution window");
    v.zNear = 0.001;
    v.backgroundBlack();
    ...
    offset[1] += 0.6f;
    auto kgv = std::make_unique<morph::HexGridVisual<float, morph::gl::version_3_1_es>>(&kernel, offset);
    v.bindmodel (kgv);
    ...
    offset[1] -= 0.6f;
    offset[0] += 1.0f;
    auto rgv = std::make_unique<morph::HexGridVisual<float, morph::gl::version_3_1_es>>(&hg, offset);
    v.bindmodel (rgv);
