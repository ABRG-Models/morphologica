...
int main()
{
    ...
    // Fixme: I want to pass in v here, not v.windows and v.shaders. How to do without circ. dep.?
    auto gv = std::make_unique<morph::GraphVisual<double>> (v.getWindow(), v.shaders, morph::vec<float>({0,0,0}));
