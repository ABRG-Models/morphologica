...
#include <morph/nn/RecurrentNetwork.h>
...
namespace recurrentnet {
    ...
    public:
        ...
        morph::nn::recurrentnet::RecurrentNetwork P;
        std::vector<Map> M;
        std::vector<Context> C;
        recurrentnet::Domain<double> domain;
        ...
        void saveMapResponse(int mapID) {
            ...
            morph::HdfData outdata(fname.str());
        ...
        void saveError(void) {
            ...
            morph::HdfData errordata(fname.str());
        ...
        void saveWeights(void){
            ...
            morph::HdfData weightdata(fname.str());
        ...
        void plotMapValues(std::vector<double> F, std::string fname, int mapIndex){
            ...
            auto qvp = std::make_unique<morph::QuadsVisual<float>> (&M[mapIndex].quads, offset, &fFlt, scale, colourMap);
            v.bindmodel (qvp);
        ...
        void plotDomainValues(std::vector<double> F, std::string fname){
            ...
            auto hgv1 = std::make_unique<morph::HexGridVisual<float>> (domain.hg.get(), offset);
            v.bindmodel (hgv1);
