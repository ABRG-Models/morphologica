...
namespace morph
{
    ...
    public:
...
#ifdef PREFER_COLOURMAP
        //! Fixme: Prefer morph::ColourMap
        ...
        /*!
         * Floating point array version of getJetColor(). Prefer morph::ColourMap.
         * \param gray gray value from 0.0 to 1.0
         * \return RGB value in jet colormap
         *
         * Note: This function is used by a few morph::Gdisplay based test programs that
         * never got transitioned to morph::Visual.
         */
        ...
        {
            std::vector<double> col;
            for (int i=0; i<3; i++) { col.push_back(1.0 - gray); }
            return col;
        }

        /*!
         * Hue-Saturation-Value to Red-Green-Blue. Inputs in range 0,1. Prefer use of
         * morph::ColourMap.
         */
        ...
        //! Rotate a cloud. Unlikely to be used in current code.
        static std::vector<std::vector<float>> rotateCloud (std::vector<std::vector<float>> cloud,
        ...
        /*!
         * TAKES A LIST OF PAIRS AND NUMBER OF PAIRS AND RETURNS A VECTOR OF CLUSTERS
