...
namespace morph {
     ...
     * Anneal object, sets paramters and then runs a loop, checking
     * Anneal::state to tell it when to compute a new value of the objective
     * function from the parameters generated by the Anneal class and when the
