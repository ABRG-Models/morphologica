...
namespace morph {
     ...
     * Magma
     */
    const float cm_magma[][3] = {{0.001462, 0.000466, 0.013866},
     ...
     * Inferno
     */
    const float cm_inferno[][3] = {{0.001462, 0.000466, 0.013866},
     ...
     * Plasma
     */
    const float cm_plasma[][3] = {{0.050383, 0.029803, 0.527975},
     ...
     * Viridis
     */
    const float cm_viridis[][3] = {{0.267004, 0.004874, 0.329415},
     ...
     * Cividis
     */
    const float cm_cividis[][3] = {{0.000000, 0.135112, 0.304751},
     ...
     * Twilight
     */
    const float cm_twilight[][3] = {{0.88575015840754434, 0.85000924943067835,  0.8879736506427196},
    ...
    // Fabio Crameri's vik perceptually uniform colourmap
    const float cm_vik[][3] = { {0.001328,0.069836,0.379529},
    ...
    const std::size_t cm_vik_len = sizeof(cm_vik)/(sizeof(float)*3);
} // namespace morph
