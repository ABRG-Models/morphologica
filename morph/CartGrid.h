...
namespace morph {
    ...
    public:
        ...
        // Create a radial representation of the image_data associated with this CartGrid
        void resampleToPolar (const morph::vVector<float>& image_data, morph::CartGrid& cg_polar, morph::vVector<float>& polar_data)
        {
#if 0 // rewriteme
