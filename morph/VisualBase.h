...
namespace morph {
    ...
    /*!
     * This is a small base class for Visual, which contains the attribute \a
     * event_handling, which makes it possible for GLFW event handling callbacks to
     * access the actual instance of Visual and its data members.
     */
    class VisualBase
    {
    protected:
