...
namespace morph {
    ...
    public:
        ...
        static ColourMapType strToColourMapType (const std::string& s)
        {
            ...
            switch (_s_crc) {
            case morph::crc32 (std::string_view{"fixed"sv}):
                cmt = morph::ColourMapType::Fixed; break;
            case morph::crc32 (std::string_view{"trichrome"sv}):
                cmt = morph::ColourMapType::Trichrome; break;
            case morph::crc32 (std::string_view{"duochrome"sv}):
                cmt = morph::ColourMapType::Duochrome; break;
            case morph::crc32 (std::string_view{"rgb"sv}):
                cmt = morph::ColourMapType::RGB; break;
            case morph::crc32 (std::string_view{"rgbmono"sv}):
                cmt = morph::ColourMapType::RGBMono; break;
            case morph::crc32 (std::string_view{"rgbgrey"sv}):
                cmt = morph::ColourMapType::RGBGrey; break;
            case morph::crc32 (std::string_view{"hsv"sv}):
                cmt = morph::ColourMapType::HSV; break;
            case morph::crc32 (std::string_view{"hsv1d"sv}):
                cmt = morph::ColourMapType::HSV1D; break;
            case morph::crc32 (std::string_view{"monochromegreen"sv}):
                cmt = morph::ColourMapType::MonochromeGreen; break;
            case morph::crc32 (std::string_view{"monochromeblue"sv}):
                cmt = morph::ColourMapType::MonochromeBlue; break;
            case morph::crc32 (std::string_view{"monochromered"sv}):
                cmt = morph::ColourMapType::MonochromeRed; break;
            case morph::crc32 (std::string_view{"monochrome"sv}):
                cmt = morph::ColourMapType::Monochrome; break;
            case morph::crc32 (std::string_view{"monovalgreen"sv}):
                cmt = morph::ColourMapType::MonovalGreen; break;
            case morph::crc32 (std::string_view{"monovalblue"sv}):
                cmt = morph::ColourMapType::MonovalBlue; break;
            case morph::crc32 (std::string_view{"monovalred"sv}):
                cmt = morph::ColourMapType::MonovalRed; break;
            case morph::crc32 (std::string_view{"monoval"sv}):
                cmt = morph::ColourMapType::Monoval; break;
            case morph::crc32 (std::string_view{"greyscale"sv}):
                cmt = morph::ColourMapType::Greyscale; break;
            case morph::crc32 (std::string_view{"greyscaleinv"sv}):
                cmt = morph::ColourMapType::GreyscaleInv; break;
            case morph::crc32 (std::string_view{"twilight"sv}):
                cmt = morph::ColourMapType::Twilight; break;
            case morph::crc32 (std::string_view{"petrov"sv}):
                cmt = morph::ColourMapType::Petrov; break;

            // Crameri
            case morph::crc32 (std::string_view{"devon"sv}):
                cmt = morph::ColourMapType::Devon; break;
            case morph::crc32 (std::string_view{"naviaw"sv}):
                cmt = morph::ColourMapType::NaviaW; break;
            case morph::crc32 (std::string_view{"broco"sv}):
                cmt = morph::ColourMapType::BrocO; break;
            case morph::crc32 (std::string_view{"acton"sv}):
                cmt = morph::ColourMapType::Acton; break;
            case morph::crc32 (std::string_view{"batlow"sv}):
                cmt = morph::ColourMapType::Batlow; break;
            case morph::crc32 (std::string_view{"berlin"sv}):
                cmt = morph::ColourMapType::Berlin; break;
            case morph::crc32 (std::string_view{"tofino"sv}):
                cmt = morph::ColourMapType::Tofino; break;
            case morph::crc32 (std::string_view{"broc"sv}):
                cmt = morph::ColourMapType::Broc; break;
            case morph::crc32 (std::string_view{"corko"sv}):
                cmt = morph::ColourMapType::CorkO; break;
            case morph::crc32 (std::string_view{"lapaz"sv}):
                cmt = morph::ColourMapType::Lapaz; break;
            case morph::crc32 (std::string_view{"bamo"sv}):
                cmt = morph::ColourMapType::BamO; break;
            case morph::crc32 (std::string_view{"vanimo"sv}):
                cmt = morph::ColourMapType::Vanimo; break;
            case morph::crc32 (std::string_view{"lajolla"sv}):
                cmt = morph::ColourMapType::Lajolla; break;
            case morph::crc32 (std::string_view{"lisbon"sv}):
                cmt = morph::ColourMapType::Lisbon; break;
            case morph::crc32 (std::string_view{"grayc"sv}):
                cmt = morph::ColourMapType::GrayC; break;
            case morph::crc32 (std::string_view{"roma"sv}):
                cmt = morph::ColourMapType::Roma; break;
            case morph::crc32 (std::string_view{"vik"sv}):
                cmt = morph::ColourMapType::Vik; break;
            case morph::crc32 (std::string_view{"navia"sv}):
                cmt = morph::ColourMapType::Navia; break;
            case morph::crc32 (std::string_view{"bilbao"sv}):
                cmt = morph::ColourMapType::Bilbao; break;
            case morph::crc32 (std::string_view{"turku"sv}):
                cmt = morph::ColourMapType::Turku; break;
            case morph::crc32 (std::string_view{"lipari"sv}):
                cmt = morph::ColourMapType::Lipari; break;
            case morph::crc32 (std::string_view{"viko"sv}):
                cmt = morph::ColourMapType::VikO; break;
            case morph::crc32 (std::string_view{"batlowk"sv}):
                cmt = morph::ColourMapType::BatlowK; break;
            case morph::crc32 (std::string_view{"oslo"sv}):
                cmt = morph::ColourMapType::Oslo; break;
            case morph::crc32 (std::string_view{"oleron"sv}):
                cmt = morph::ColourMapType::Oleron; break;
            case morph::crc32 (std::string_view{"davos"sv}):
                cmt = morph::ColourMapType::Davos; break;
            case morph::crc32 (std::string_view{"fes"sv}):
                cmt = morph::ColourMapType::Fes; break;
            case morph::crc32 (std::string_view{"managua"sv}):
                cmt = morph::ColourMapType::Managua; break;
            case morph::crc32 (std::string_view{"glasgow"sv}):
                cmt = morph::ColourMapType::Glasgow; break;
            case morph::crc32 (std::string_view{"tokyo"sv}):
                cmt = morph::ColourMapType::Tokyo; break;
            case morph::crc32 (std::string_view{"bukavu"sv}):
                cmt = morph::ColourMapType::Bukavu; break;
            case morph::crc32 (std::string_view{"bamako"sv}):
                cmt = morph::ColourMapType::Bamako; break;
            case morph::crc32 (std::string_view{"batloww"sv}):
                cmt = morph::ColourMapType::BatlowW; break;
            case morph::crc32 (std::string_view{"nuuk"sv}):
                cmt = morph::ColourMapType::Nuuk; break;
            case morph::crc32 (std::string_view{"cork"sv}):
                cmt = morph::ColourMapType::Cork; break;
            case morph::crc32 (std::string_view{"hawaii"sv}):
                cmt = morph::ColourMapType::Hawaii; break;
            case morph::crc32 (std::string_view{"bam"sv}):
                cmt = morph::ColourMapType::Bam; break;
            case morph::crc32 (std::string_view{"imola"sv}):
                cmt = morph::ColourMapType::Imola; break;
            case morph::crc32 (std::string_view{"romao"sv}):
                cmt = morph::ColourMapType::RomaO; break;
            case morph::crc32 (std::string_view{"buda"sv}):
                cmt = morph::ColourMapType::Buda; break;

            // Lenthe
            case morph::crc32 (std::string_view{"fire"sv}):
                cmt = morph::ColourMapType::Fire; break;
            case morph::crc32 (std::string_view{"ocean"sv}):
                cmt = morph::ColourMapType::Ocean; break;
            case morph::crc32 (std::string_view{"ice"sv}):
                cmt = morph::ColourMapType::Ice; break;
            case morph::crc32 (std::string_view{"divbluered"sv}):
                cmt = morph::ColourMapType::DivBlueRed; break;
            case morph::crc32 (std::string_view{"cyclicgrey"sv}):
                cmt = morph::ColourMapType::CyclicGrey; break;
            case morph::crc32 (std::string_view{"cyclicfour"sv}):
                cmt = morph::ColourMapType::CyclicFour; break;
            case morph::crc32 (std::string_view{"cyclicsix"sv}):
                cmt = morph::ColourMapType::CyclicSix; break;
            case morph::crc32 (std::string_view{"cyclicdivbluered"sv}):
                cmt = morph::ColourMapType::CyclicDivBlueRed; break;
            case morph::crc32 (std::string_view{"discfourwhite"sv}):
                cmt = morph::ColourMapType::DiscFourWhite; break;
            case morph::crc32 (std::string_view{"discfourblack"sv}):
                cmt = morph::ColourMapType::DiscFourBlack; break;
            case morph::crc32 (std::string_view{"discsixwhite"sv}):
                cmt = morph::ColourMapType::DiscSixWhite; break;
            case morph::crc32 (std::string_view{"discsixblack"sv}):
                cmt = morph::ColourMapType::DiscSixBlack; break;

            // CET
            case morph::crc32 (std::string_view{"cet_l02"sv}):
                cmt = morph::ColourMapType::CET_L02; break;
            case morph::crc32 (std::string_view{"cet_l13"sv}):
                cmt = morph::ColourMapType::CET_L13; break;
            case morph::crc32 (std::string_view{"cet_c4"sv}):
                cmt = morph::ColourMapType::CET_C4; break;
            case morph::crc32 (std::string_view{"cet_d04"sv}):
                cmt = morph::ColourMapType::CET_D04; break;
            case morph::crc32 (std::string_view{"cet_l12"sv}):
                cmt = morph::ColourMapType::CET_L12; break;
            case morph::crc32 (std::string_view{"cet_c1s"sv}):
                cmt = morph::ColourMapType::CET_C1s; break;
            case morph::crc32 (std::string_view{"cet_l01"sv}):
                cmt = morph::ColourMapType::CET_L01; break;
            case morph::crc32 (std::string_view{"cet_c5"sv}):
                cmt = morph::ColourMapType::CET_C5; break;
            case morph::crc32 (std::string_view{"cet_d11"sv}):
                cmt = morph::ColourMapType::CET_D11; break;
            case morph::crc32 (std::string_view{"cet_l04"sv}):
                cmt = morph::ColourMapType::CET_L04; break;
            case morph::crc32 (std::string_view{"cet_cbl2"sv}):
                cmt = morph::ColourMapType::CET_CBL2; break;
            case morph::crc32 (std::string_view{"cet_c4s"sv}):
                cmt = morph::ColourMapType::CET_C4s; break;
            case morph::crc32 (std::string_view{"cet_l15"sv}):
                cmt = morph::ColourMapType::CET_L15; break;
            case morph::crc32 (std::string_view{"cet_l20"sv}):
                cmt = morph::ColourMapType::CET_L20; break;
            case morph::crc32 (std::string_view{"cet_cbd1"sv}):
                cmt = morph::ColourMapType::CET_CBD1; break;
            case morph::crc32 (std::string_view{"cet_d06"sv}):
                cmt = morph::ColourMapType::CET_D06; break;
            case morph::crc32 (std::string_view{"cet_i3"sv}):
                cmt = morph::ColourMapType::CET_I3; break;
            case morph::crc32 (std::string_view{"cet_d01a"sv}):
                cmt = morph::ColourMapType::CET_D01A; break;
            case morph::crc32 (std::string_view{"cet_l16"sv}):
                cmt = morph::ColourMapType::CET_L16; break;
            case morph::crc32 (std::string_view{"cet_l06"sv}):
                cmt = morph::ColourMapType::CET_L06; break;
            case morph::crc32 (std::string_view{"cet_c2s"sv}):
                cmt = morph::ColourMapType::CET_C2s; break;
            case morph::crc32 (std::string_view{"cet_i1"sv}):
                cmt = morph::ColourMapType::CET_I1; break;
            case morph::crc32 (std::string_view{"cet_c7s"sv}):
                cmt = morph::ColourMapType::CET_C7s; break;
            case morph::crc32 (std::string_view{"cet_i2"sv}):
                cmt = morph::ColourMapType::CET_I2; break;
            case morph::crc32 (std::string_view{"cet_c6s"sv}):
                cmt = morph::ColourMapType::CET_C6s; break;
            case morph::crc32 (std::string_view{"cet_c6"sv}):
                cmt = morph::ColourMapType::CET_C6; break;
            case morph::crc32 (std::string_view{"cet_l05"sv}):
                cmt = morph::ColourMapType::CET_L05; break;
            case morph::crc32 (std::string_view{"cet_d08"sv}):
                cmt = morph::ColourMapType::CET_D08; break;
            case morph::crc32 (std::string_view{"cet_l03"sv}):
                cmt = morph::ColourMapType::CET_L03; break;
            case morph::crc32 (std::string_view{"cet_l14"sv}):
                cmt = morph::ColourMapType::CET_L14; break;
            case morph::crc32 (std::string_view{"cet_c2"sv}):
                cmt = morph::ColourMapType::CET_C2; break;
            case morph::crc32 (std::string_view{"cet_r3"sv}):
                cmt = morph::ColourMapType::CET_R3; break;
            case morph::crc32 (std::string_view{"cet_d01"sv}):
                cmt = morph::ColourMapType::CET_D01; break;
            case morph::crc32 (std::string_view{"cet_c1"sv}):
                cmt = morph::ColourMapType::CET_C1; break;
            case morph::crc32 (std::string_view{"cet_d02"sv}):
                cmt = morph::ColourMapType::CET_D02; break;
            case morph::crc32 (std::string_view{"cet_cbc1"sv}):
                cmt = morph::ColourMapType::CET_CBC1; break;
            case morph::crc32 (std::string_view{"cet_d09"sv}):
                cmt = morph::ColourMapType::CET_D09; break;
            case morph::crc32 (std::string_view{"cet_l10"sv}):
                cmt = morph::ColourMapType::CET_L10; break;
            case morph::crc32 (std::string_view{"cet_r1"sv}):
                cmt = morph::ColourMapType::CET_R1; break;
            case morph::crc32 (std::string_view{"cet_c3"sv}):
                cmt = morph::ColourMapType::CET_C3; break;
            case morph::crc32 (std::string_view{"cet_cbl1"sv}):
                cmt = morph::ColourMapType::CET_CBL1; break;
            case morph::crc32 (std::string_view{"cet_c3s"sv}):
                cmt = morph::ColourMapType::CET_C3s; break;
            case morph::crc32 (std::string_view{"cet_c5s"sv}):
                cmt = morph::ColourMapType::CET_C5s; break;
            case morph::crc32 (std::string_view{"cet_l08"sv}):
                cmt = morph::ColourMapType::CET_L08; break;
            case morph::crc32 (std::string_view{"cet_r4"sv}):
                cmt = morph::ColourMapType::CET_R4; break;
            case morph::crc32 (std::string_view{"cet_r2"sv}):
                cmt = morph::ColourMapType::CET_R2; break;
            case morph::crc32 (std::string_view{"cet_l11"sv}):
                cmt = morph::ColourMapType::CET_L11; break;
            case morph::crc32 (std::string_view{"cet_d10"sv}):
                cmt = morph::ColourMapType::CET_D10; break;
            case morph::crc32 (std::string_view{"cet_d07"sv}):
                cmt = morph::ColourMapType::CET_D07; break;
            case morph::crc32 (std::string_view{"cet_l17"sv}):
                cmt = morph::ColourMapType::CET_L17; break;
            case morph::crc32 (std::string_view{"cet_d12"sv}):
                cmt = morph::ColourMapType::CET_D12; break;
            case morph::crc32 (std::string_view{"cet_cbc2"sv}):
                cmt = morph::ColourMapType::CET_CBC2; break;
            case morph::crc32 (std::string_view{"cet_d13"sv}):
                cmt = morph::ColourMapType::CET_D13; break;
            case morph::crc32 (std::string_view{"cet_d03"sv}):
                cmt = morph::ColourMapType::CET_D03; break;
            case morph::crc32 (std::string_view{"cet_c7"sv}):
                cmt = morph::ColourMapType::CET_C7; break;
            case morph::crc32 (std::string_view{"cet_l07"sv}):
                cmt = morph::ColourMapType::CET_L07; break;
            case morph::crc32 (std::string_view{"cet_l09"sv}):
                cmt = morph::ColourMapType::CET_L09; break;
            case morph::crc32 (std::string_view{"cet_l18"sv}):
                cmt = morph::ColourMapType::CET_L18; break;
            case morph::crc32 (std::string_view{"cet_l19"sv}):
                cmt = morph::ColourMapType::CET_L19; break;

            case morph::crc32 (std::string_view{"cividis"sv}):
                cmt = morph::ColourMapType::Cividis; break;
            case morph::crc32 (std::string_view{"viridis"sv}):
                cmt = morph::ColourMapType::Viridis; break;
            case morph::crc32 (std::string_view{"plasma"sv}):
                cmt = morph::ColourMapType::Plasma; break;
            case morph::crc32 (std::string_view{"inferno"sv}):
                cmt = morph::ColourMapType::Inferno; break;
            case morph::crc32 (std::string_view{"magma"sv}):
                cmt = morph::ColourMapType::Magma; break;
            case morph::crc32 (std::string_view{"rainbowzerowhite"sv}):
                cmt = morph::ColourMapType::RainbowZeroWhite; break;
            case morph::crc32 (std::string_view{"rainbowzeroblack"sv}):
                cmt = morph::ColourMapType::RainbowZeroBlack; break;
            case morph::crc32 (std::string_view{"rainbow"sv}):
                cmt = morph::ColourMapType::Rainbow; break;
            case morph::crc32 (std::string_view{"jet"}):
