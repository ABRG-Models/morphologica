...
namespace morph {
    ...
    class VisualModel : public morph::VisualModelBase<glver>
    {
        //! Debug rendering process with cout messages
        static constexpr bool debug_render = false;

    public:
        VisualModel() : morph::VisualModelBase<glver>::VisualModelBase() {}
        VisualModel (const vec<float> _mv_offset) : morph::VisualModelBase<glver>::VisualModelBase(_mv_offset) {}
