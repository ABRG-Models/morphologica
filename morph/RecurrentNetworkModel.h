        ...
        public:
            ...
            */
            ...
            void plotMapValues(std::vector<double> F, std::string fname, int mapIndex){
                ...
                auto qvp = std::make_unique<QuadsVisual<float>> (v.shaderprog, &M[mapIndex].quads, offset, &fFlt, scale, colourMap);
            ...
            void plotDomainValues(std::vector<double> F, std::string fname){
                ...
                auto hgv1 = std::make_unique<HexGridVisual<float>> (v.shaderprog, v.tshaderprog, domain.hg, offset);
