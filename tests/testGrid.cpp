...
int main()
{
    ...
    morph::Gridct<2, 2, grid_spacing, grid_zero, with_memory, morph::CartDomainWrap::None, morph::GridOrder::bottomleft_to_topright> grid1;
    ...
    morph::Gridct<2, 2, grid_spacing, grid_zero, non_memory, morph::CartDomainWrap::None, morph::GridOrder::bottomleft_to_topright> grid1p1;
    ...
    morph::Gridct<2, 2, grid_spacing, grid_zero, with_memory, morph::CartDomainWrap::Horizontal, morph::GridOrder::bottomleft_to_topright> grid2;
    ...
    morph::Gridct<2, 2, grid_spacing, grid_zero, with_memory, morph::CartDomainWrap::Both, morph::GridOrder::bottomleft_to_topright> grid3;
    ...
    morph::Gridct<2, 2, grid_spacing, grid_zero, with_memory, morph::CartDomainWrap::None, morph::GridOrder::topleft_to_bottomright> grid4;
    ...
    morph::Gridct<2, 2, grid_spacing, grid_zero, with_memory, morph::CartDomainWrap::Vertical, morph::GridOrder::topleft_to_bottomright> grid5;
