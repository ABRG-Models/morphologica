...
int main()
{
    ...
    v.push_back (make_pair (300,450));
    v.push_back (make_pair (400,400));
    v.push_back (make_pair (450,300));

    vector<pair<FLT,FLT>> w;
    w.push_back (v.back());
    w.push_back (make_pair (500,200));
    w.push_back (make_pair (580,50));
    w.push_back (make_pair (630,20));
