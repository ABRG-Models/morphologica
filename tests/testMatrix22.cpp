...
void setMatrixSequence (morph::mat22<float>& tm)
{
    tm.mat = { 0, 1, 2, 3 };
}
...
int main()
{
    ...
    // Test assignment
    morph::mat22<float> tm1;
    setMatrixSequence (tm1);
    morph::mat22<float> tm2 = tm1;
    ...
    morph::mat22<float> mi;
    mi.mat = { -1, 2, 3, -2 };

    morph::mat22<float> miinv = mi.invert();
    std::cout << "mi\n" << mi << std::endl;
    std::cout << "mi.invert():\n" << miinv << std::endl;

    // Test multiplication
    morph::mat22<float> mult1;
    setMatrixSequence (mult1);
    std::cout << "mult1\n" << mult1 << std::endl;

    morph::mat22<float> mult2;
    mult2.mat = { 5, 4, 3, 2 };
    std::cout << "mult2\n" << mult2 << std::endl;

    morph::mat22<float> mult3 = mult1 * mult2;
    std::cout << "mult1 * mult2 =\n" << mult3 << std::endl;

    morph::mat22<float> mult3alt = mult1 * mult2.mat;
    std::cout << "mult1 * mult2.mat =\n" << mult3alt << std::endl;

    morph::mat22<float> mult2_t = mult2;
    mult2_t.transpose();
    ...
    morph::mat22<float> mult1save = mult1;
    mult1 *= mult2;
